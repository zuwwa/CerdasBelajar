...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $query = "INSERT INTO jadwal (id_mapel, id_kelas, hari, jam_mulai, jam_selesai, ruang) 
            VALUES (?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $query);
  mysqli_stmt_bind_param($stmt, "iissss", $id_mapel, $id_kelas, $hari, $jam_mulai, $jam_selesai, $ruang);
