...
// Ambil data jadwal, join dengan kelas dan mapel
$query = "SELECT j.*, k.kelas, m.Nama as nama_mapel, m.Guru 
          FROM jadwal j 
          JOIN t_kelas k ON j.id_kelas = k.id 
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title">Manajemen Jadwal Pelajaran</h4>
<p class="card-description">Kelola jadwal pelajaran berdasarkan kelas dan mata pelajaran.</p>

<a href="jadwal_tambah.php" class="btn btn-primary btn-sm mb-3">+ Tambah Jadwal</a>
    ...
    <tbody>
      <?php $no = 1; foreach ($jadwal as $row): ?>
        <tr>
          ...
          <td><?= $row['ruang'] ?></td>
          <td>
            <a href="jadwal_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
            <a href="jadwal_hapus.php?id=<?= $row['id'] ?>" onclick="return confirm('Yakin hapus jadwal?')" class="btn btn-sm btn-danger">Hapus</a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
