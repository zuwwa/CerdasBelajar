...
$data_penilaian = [];
$query = "SELECT * FROM t_guru_penilaian ORDER BY nama ASC";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Guru Penilaian</h4>
                  <p class="card-description">
                    Daftar penilaian guru yang terdaftar di SMAN 1 Sukabumi.
                  </p>
                  <div class="d-flex justify-content-start align-items-center mb-4">
                    ...
                    <a href="agenda.php" class="btn btn-success">
                      <i class="typcn typcn-clipboard"></i> Agenda Guru
                    </a>
                  </div>
  ...
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php if (!empty($data_penilaian)): ?>
        <?php $no = 1; foreach ($data_penilaian as $row): ?>
          <tr>
            <td><?= $no++ ?></td>
            <td><?= htmlspecialchars($row['nama']) ?></td>
            <td><?= htmlspecialchars($row['noinduk']) ?></td>
            ...
            <td><strong><?= htmlspecialchars($row['nilai']) ?></strong></td>
          </tr>
        <?php endforeach; ?>
      <?php else: ?>
        <tr>
          <td colspan="9" class="text-center text-muted">Belum ada data penilaian guru.</td>
        </tr>
      <?php endif; ?>
    </tbody>
  </table>
