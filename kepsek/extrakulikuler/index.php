...
$data_ekstra = [];
$query = "SELECT * FROM t_ekstrakurikuler ORDER BY ekstrakurikuler ASC";
...
if ($result) {
  ...
  redirectWithError('Gagal mengambil data ekstrakurikuler.');
}
...
<head>
  <meta charset="UTF-8">
  <title>Ekstrakurikuler Siswa - CerdasBelajar</title>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Daftar kegiatan ekstrakurikuler yang tersedia di SMAN 1 Sukabumi.
                  </p>
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        <?php if (!empty($data_ekstra)) : ?>
                          <?php $no = 1;
                          foreach ($data_ekstra as $ekstra): ?>
                            <tr>
                              <td><?= $no++ ?></td>
                              <td><?= htmlspecialchars($ekstra['ekstrakurikuler']) ?></td>
                              <td><?= htmlspecialchars($ekstra['deskripsi']) ?></td>
                              <td><?= $ekstra['id_sekolah'] ?></td>
                            </tr>
                          <?php endforeach ?>
                        <?php else: ?>
                          <tr>
                            <td colspan="4" class="text-center text-muted">Belum ada data ekstrakurikuler.</td>
                          </tr>
                        <?php endif ?>
                      </tbody>
                    </table>
