...
// Contoh: Mengambil mata pelajaran dan nilai mapel untuk grafik
$labels_mapel = [];
$data_nilai_mapel = [];

foreach ($data_nilai as $nilai) {
    $labels_mapel[] = htmlspecialchars($nilai['mata_pelajaran']) . ' (' . htmlspecialchars($nilai['nis']) . ')';
    $data_nilai_mapel[] = (int) $nilai['nilai_mapel'];
}
...
<head>
    <meta charset="UTF-8">
    <title>Grafik Nilai Siswa - CerdasBelajar</title>
    ...
    <div class="container-scroller">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title mt-5">Tabel Data Nilai Siswa</h4>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const ctx = document.getElementById('nilaiMapelChart').getContext('2d');
                const nilaiMapelChart = new Chart(ctx, {
                    type: 'bar', // Anda bisa ganti 'bar' dengan 'line', 'pie', 'doughnut', dll.
                    data: {
                        labels: <?= json_encode($labels_mapel) ?>, // Ambil dari PHP
                        datasets: [{
                            label: 'Nilai Mata Pelajaran',
                            data: <?= json_encode($data_nilai_mapel) ?>, // Ambil dari PHP
                            backgroundColor: 'rgba(2, 40, 122, 0.7)',
                            borderColor: 'rgba(2, 40, 122, 1)',
                            borderWidth: 1
                        }]
                    },
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: true,
                                text: 'Grafik Nilai Mata Pelajaran Siswa'
                            },
                            tooltip: {
                                callbacks: {
